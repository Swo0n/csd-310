...
cursor3 = mydb.cursor()
cursor3.execute("SELECT inventory.product_name, equipment.restock_date, equipment.equip_expired from inventory JOIN equipment ON inventory.inventory_id = equipment.inventory_id WHERE equipment.restock_date < DATE_SUB('2023-07-15', INTERVAL 5 YEAR)")
